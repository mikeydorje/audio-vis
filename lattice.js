// --- Lattice: Sharp Decentralized Crystalline Grid ---
// No core — particles at irregular grid intersections, everything relational to neighbors
...
// --- Particle Grid (decentralized lattice) ---
let particles;
...
function animate() {
  ...
  const rotDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 0.92)) * 0.05;
