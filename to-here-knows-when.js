...
const vertexShader = `
  ...
  void main() {
    ...
    int idx2 = int(clamp(floor(aAlong * 63.0), 0.0, 63.0));
    ...
    newPos.x += scatter + trail + detune;
    newPos.y += scatterY + sin(uTime * 0.01 + aAlong * 2.0) * 0.05;
    newPos.z += trailZ;
...
const uniforms = {
  ...
  uHaze: { value: 0.5 }, uThreshold: { value: 0.5 },
...
window.SCENE = {
  ...
  get playState() { return playState; }, sceneName: 'to-here-knows-when'
};
animate();
