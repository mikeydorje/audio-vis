// --- Pi: Audio-Reactive Mathematical Morphing ---
// Particles morph between π-derived geometric forms:
// Archimedes polygon approximation, rose curves, Fourier/Leibniz series harmonics
// π defines every shape here — circumference, inscribed polygons, harmonic analysis
...
const vertexShader = `
  ...
  void main() {
    ...
    // --- Euler phase rotation: e^(iπ) rotates the complex plane ---
...
// --- Geometry: Concentric rings with θ sampling ---
...
function animate() {
  ...
  if (analyser && dataArray) {
    ...
    for (let i = 0; i < 64; i++) frequencyUniform[i] = dataArray[i];
  }
