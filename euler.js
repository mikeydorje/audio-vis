// --- e (Euler's Number): Audio-Reactive Exponential Morphing ---
// e = 2.71828... The base of natural growth. Equiangular spiral, Gaussian bell, catenary.
// Silence = concentric circles. Sound morphs them into the three canonical e-curves.
...
const vertexShader = `
  ...
  void main() {
    ...
    // --- Equiangular spiral: r modulation = exp(b * theta) ---
    ...
    // --- Gaussian bell: radial pulse = exp(-deviation^2 / 2sigma^2) ---
    ...
    // --- Catenary: radial = cosh((theta - pi)/a) ---
...
// Narrative: Zero → Growth → Compound → Peak → Decay
function storyArc(p) {
