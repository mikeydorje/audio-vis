// --- Mathematical Pony: Audio-Reactive Lissajous Harmonograph ---
// "Mathematical!" — A harmonograph gone wild. Concentric rings warped by
// layered Lissajous figures: x=sin(at+δ), y=sin(bt). Integer ratios make
// stars and knots; audio detunes them into precessing, space-filling madness.
// Full rainbow palette. Adventure Time energy. Algebraic. 
...
// Narrative: Circle → Wobble → Harmonograph → Wild → Serenity
function storyArc(p) {
