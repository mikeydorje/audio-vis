// --- Spore: Sharp Decentralized Organic Scatter ---
// No bloom center — scattered seed clusters floating in relation to each other, crisp points
...
// --- Particle Clusters (decentralized seed nodes) ---
let particles;
...
function animate() {
  ...
  const rotDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 0.92)) * 0.06;
  const tiltDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 1.38) + 2.0) * 0.03;
