// --- Filament: Sharp Decentralized Cosmic Web ---
// No center — particles trace curved strands that weave through space, all relative to each other
...
// --- Particle Strands (decentralized filaments) ---
let particles;
...
function animate() {
  ...
  const rotDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 0.92)) * 0.1;
  const tiltDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 1.38) + 2.0) * 0.06;
