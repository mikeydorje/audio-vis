...
function animate() {
  ...
  const rotDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 0.92)) * 0.08;
  const tiltDrift = Math.sin(elapsed * TWO_PI / (DRIFT_BASE * 1.38) + 2.0) * 0.04;
